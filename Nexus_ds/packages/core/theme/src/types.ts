...
/**
 * The nexusui config.
 * @see https://nexusui.org/docs/customization/customize-theme
 */
export type nexusuiPluginConfig = {
  /**
  ...
  prefix?: string;
  /**
   * If true, the common nexusui colors (e.g. "blue", "green", "purple") will not be extended on the theme.
   * @default false
   */

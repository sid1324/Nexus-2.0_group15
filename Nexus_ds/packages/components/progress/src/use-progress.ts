import type {ProgressVariantProps, SlotsToClasses, ProgressSlots} from "@nexus-ds/theme";
import type {PropGetter} from "@nexus-ds/system";
import type {AriaProgressBarProps} from "@react-types/progress";

import {HTMLnexusuiProps, mapPropsVariants} from "@nexus-ds/system";
import {progress} from "@nexus-ds/theme";
import {useDOMRef} from "@nexus-ds/react-utils";
import {clampPercentage, clsx, dataAttr} from "@nexus-ds/shared-utils";
import {ReactRef} from "@nexus-ds/react-utils";
import {mergeProps} from "@react-aria/utils";
import {useMemo, useCallback} from "react";
import {useIsMounted} from "@nexus-ds/use-is-mounted";

import type {TabsVariantProps, SlotsToClasses, TabsSlots, TabsReturnType} from "@nexus-ds/theme";

import {HTMLnexusuiProps, mapPropsVariants, PropGetter} from "@nexus-ds/system";
import {tabs} from "@nexus-ds/theme";
...
export interface Props extends Omit<HTMLnexusuiProps, "children"> {
  /**
   * Ref to the DOM node.
   */

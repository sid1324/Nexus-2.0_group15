import type {CheckboxVariantProps, CheckboxSlots, SlotsToClasses} from "@nexus-ds/theme";
...
import {checkbox} from "@nexus-ds/theme";
import {useHover, usePress} from "@react-aria/interactions";
import {useFocusRing} from "@react-aria/focus";
import {chain, mergeProps} from "@react-aria/utils";
import {useFocusableRef} from "@nexus-ds/react-utils";
import {__DEV__, warn, clsx, dataAttr, safeAriaLabel} from "@nexus-ds/shared-utils";
import {
...
interface Props extends Omit<HTMLnexusuiProps<"input">, keyof CheckboxVariantProps> {
  /**
   * Ref to the DOM node.
   */

import type {InputVariantProps, SlotsToClasses, InputSlots} from "@nexus-ds/theme";

import {HTMLnexusuiProps, mapPropsVariants, PropGetter} from "@nexus-ds/system";
import {AriaTextFieldProps} from "@react-types/textfield";
import {useFocusRing} from "@react-aria/focus";
import {input} from "@nexus-ds/theme";
import {useDOMRef, filterDOMProps} from "@nexus-ds/react-utils";
import {useFocusWithin, useHover, usePress} from "@react-aria/interactions";
import {clsx, dataAttr, safeAriaLabel} from "@nexus-ds/shared-utils";
...
export interface Props<T extends HTMLInputElement | HTMLTextAreaElement = HTMLInputElement>
  extends Omit<HTMLnexusuiProps<"input">, keyof InputVariantProps> {
  /**
   * Ref to the DOM node.
   */
  ref?: Ref<T>;

...
import {Checkbox} from "@nexus-ds/checkbox";
import {VisuallyHidden} from "@react-aria/visually-hidden";

import {ValuesType} from "./use-table";

export interface TableSelectAllCheckboxProps<T = object> extends HTMLnexusuiProps<"th"> {
  /**
   * The table column.
   */
  node: GridNode<T>;
...
TableSelectAllCheckbox.displayName = "nexusui.TableSelectAllCheckbox";

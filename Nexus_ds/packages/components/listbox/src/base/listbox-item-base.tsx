import type {ListboxItemVariantProps, ListboxItemSlots, SlotsToClasses} from "@nexus-ds/theme";
...
interface Props<T extends object = {}> extends Omit<ItemProps<"li", T>, "children" | "title"> {
   ...
   * If you pass a function, nexusui will expose the current selected icon and the selected status,

...
import {listboxItem} from "@nexus-ds/theme";
import {HTMLnexusuiProps, mapPropsVariants, PropGetter} from "@nexus-ds/system";
import {useFocusRing} from "@react-aria/focus";
import {Node} from "@react-types/shared";
import {filterDOMProps} from "@nexus-ds/react-utils";
import {clsx, dataAttr, removeEvents} from "@nexus-ds/shared-utils";
import {useOption} from "@react-aria/listbox";
import {mergeProps} from "@react-aria/utils";
import {useHover, usePress} from "@react-aria/interactions";
import {useIsMobile} from "@nexus-ds/use-is-mobile";
...
export type UseListboxItemProps<T extends object> = Props<T> &
  Omit<HTMLnexusuiProps<"li">, keyof Props<T>>;

import type {PaginationSlots, PaginationVariantProps, SlotsToClasses} from "@nexus-ds/theme";
import type {Timer} from "@nexus-ds/shared-utils";
...
import {
  ...
  PaginationItemValue,
  PaginationItemType,
} from "@nexus-ds/use-pagination";
import {useEffect, useRef, useMemo} from "react";
import {mapPropsVariants} from "@nexus-ds/system";
import {usePagination as useBasePagination} from "@nexus-ds/use-pagination";
import scrollIntoView from "scroll-into-view-if-needed";
import {pagination} from "@nexus-ds/theme";
...
interface Props extends Omit<HTMLnexusuiProps<"nav">, "onChange"> {
  /**
   * Ref to the DOM node.
   */
  ref?: Ref<HTMLElement>;

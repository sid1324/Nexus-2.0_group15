...
import {PaginationItemType} from "@nexus-ds/use-pagination";
...
export interface UsePaginationItemProps extends Omit<HTMLnexusuiProps<"li">, "onClick"> {
  /**
   * Ref to the DOM node.
   */
  ref?: Ref<HTMLElement>;
   ...
   */
  onClick?: HTMLnexusuiProps<"li">["onClick"];
  /**
   * Callback fired when the item is clicked.
   * @param e PressEvent
   */

import type {NavbarVariantProps, SlotsToClasses, NavbarSlots} from "@nexus-ds/theme";
...
import {useScrollPosition} from "@nexus-ds/use-scroll-position";
import {useControlledState} from "@react-stately/utils";
import {HTMLMotionProps} from "framer-motion";

interface Props extends HTMLnexusuiProps<"nav"> {
  /**
   * Ref to the DOM node.
   */

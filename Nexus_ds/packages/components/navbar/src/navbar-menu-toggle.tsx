import {AriaToggleButtonProps, useAriaToggleButton} from "@nexus-ds/use-aria-toggle-button";
...
export interface Props extends Omit<HTMLnexusuiProps<"button">, keyof AriaToggleButtonProps> {
  /**
...
NavbarMenuToggle.displayName = "nexusui.NavbarMenuToggle";

import type {SelectSlots, SelectVariantProps, SlotsToClasses} from "@nexus-ds/theme";
import type {HiddenSelectProps} from "./hidden-select";

import {DOMAttributes, HTMLnexusuiProps, mapPropsVariants, PropGetter} from "@nexus-ds/system";
import {select} from "@nexus-ds/theme";
import {ReactRef, useDOMRef, filterDOMProps} from "@nexus-ds/react-utils";
import {useMemo, useCallback, useRef, Key, ReactNode, useEffect} from "react";
import {ListboxProps} from "@nexus-ds/listbox";
import {useAriaButton} from "@nexus-ds/use-aria-button";
import {useFocusRing} from "@react-aria/focus";
import {clsx, dataAttr} from "@nexus-ds/shared-utils";
import {mergeProps} from "@react-aria/utils";
import {useHover} from "@react-aria/interactions";
import {PopoverProps} from "@nexus-ds/popover";
import {CollectionProps} from "@nexus-ds/aria-utils";
import {CollectionChildren} from "@react-types/shared";
import {ScrollShadowProps} from "@nexus-ds/scroll-shadow";
import {
  MultiSelectProps,
  useMultiSelect,
  useMultiSelectState,
} from "@nexus-ds/use-aria-multiselect";
import {SpinnerProps} from "@nexus-ds/spinner";
...
interface Props<T> extends Omit<HTMLnexusuiProps<"select">, keyof SelectVariantProps> {
  /**
   * Ref to the DOM node.
   */

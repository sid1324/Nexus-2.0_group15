import type {ChipVariantProps, ChipSlots, SlotsToClasses} from "@nexus-ds/theme";
...
import {chip} from "@nexus-ds/theme";
...
export interface UseChipProps extends HTMLnexusuiProps, ChipVariantProps {
  /**
   * Ref to the DOM node.
   */

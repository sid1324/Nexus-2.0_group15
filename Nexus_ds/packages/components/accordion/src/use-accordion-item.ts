import {HTMLnexusuiProps, PropGetter} from "@nexus-ds/system";
import {useFocusRing} from "@react-aria/focus";
import {accordionItem} from "@nexus-ds/theme";
import {clsx, callAllHandlers, dataAttr} from "@nexus-ds/shared-utils";
import {ReactRef, useDOMRef, filterDOMProps} from "@nexus-ds/react-utils";
import {NodeWithProps} from "@nexus-ds/aria-utils";
import {useReactAriaAccordionItem} from "@nexus-ds/use-aria-accordion";
...
export interface Props<T extends object> extends HTMLnexusuiProps<"div"> {
  /**
   * Ref to the DOM node.
   */

...
import type {ButtonGroupVariantProps} from "@nexus-ds/theme";

import {buttonGroup} from "@nexus-ds/theme";
import {HTMLnexusuiProps, PropGetter, mapPropsVariants} from "@nexus-ds/system";
import {useDOMRef} from "@nexus-ds/react-utils";
import {useMemo, useCallback} from "react";
interface Props extends HTMLnexusuiProps, ButtonGroupVariantProps {
  /**
   * Ref to the DOM node.
   */

import type {ToggleVariantProps, ToggleSlots, SlotsToClasses} from "@nexus-ds/theme";
...
import {toggle} from "@nexus-ds/theme";
...
interface Props extends HTMLnexusuiProps<"label"> {
  /**
   * Ref to the DOM node.
   */
  ref?: Ref<HTMLElement>;

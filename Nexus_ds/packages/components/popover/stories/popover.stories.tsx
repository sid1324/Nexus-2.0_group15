...
import {popover, ButtonVariantProps} from "@nexus-ds/theme";
import {Button} from "@nexus-ds/button";
import {Input} from "@nexus-ds/input";
import {Card, CardHeader, CardFooter} from "@nexus-ds/card";
    ...
    <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t border-default-600 dark:border-default-100">
      <div className="flex flex-grow gap-2 items-center">
        <img
          ...
          src="https://nexusui.org/images/breathing-app-icon.jpeg"
        />

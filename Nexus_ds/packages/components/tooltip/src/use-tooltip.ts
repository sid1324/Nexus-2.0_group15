import type {PopoverVariantProps, SlotsToClasses} from "@nexus-ds/theme";
import type {AriaTooltipProps} from "@react-types/tooltip";
import type {OverlayTriggerProps} from "@react-types/overlays";
import type {HTMLMotionProps} from "framer-motion";
import type {OverlayOptions} from "@nexus-ds/aria-utils";
...
import {popover} from "@nexus-ds/theme";
import {clsx, dataAttr} from "@nexus-ds/shared-utils";
import {ReactRef, mergeRefs} from "@nexus-ds/react-utils";
import {createDOMRef} from "@nexus-ds/react-utils";
import {useMemo, useRef, useCallback} from "react";
import {toReactAriaPlacement, getArrowPlacement} from "@nexus-ds/aria-utils";

interface Props extends Omit<HTMLnexusuiProps, "content"> {
  /**
   * Ref to the DOM node.
   */

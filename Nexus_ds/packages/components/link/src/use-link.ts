...
import type {LinkVariantProps} from "@nexus-ds/theme";

import {link} from "@nexus-ds/theme";
import {useAriaLink} from "@nexus-ds/use-aria-link";
...
interface Props extends HTMLnexusuiProps<"a">, LinkVariantProps {
  /**
   * Ref to the DOM node.
   */

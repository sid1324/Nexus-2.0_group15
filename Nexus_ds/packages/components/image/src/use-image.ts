...
import {useImage as useImageBase} from "@nexus-ds/use-image";
import {useMemo} from "react";
type NativeImageProps = ImgHTMLAttributes<HTMLImageElement>;

interface Props extends HTMLnexusuiProps<"img"> {
  /**
   * Ref to the DOM node.
   */

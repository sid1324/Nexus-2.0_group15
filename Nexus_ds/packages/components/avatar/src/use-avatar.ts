import type {AvatarSlots, AvatarVariantProps, SlotsToClasses} from "@nexus-ds/theme";
...
import {clsx, safeText, dataAttr} from "@nexus-ds/shared-utils";
import {ReactRef} from "@nexus-ds/react-utils";
import {useFocusRing} from "@react-aria/focus";
import {useMemo, useCallback} from "react";
import {useImage} from "@nexus-ds/use-image";
import {useHover} from "@react-aria/interactions";

import {useAvatarGroupContext} from "./avatar-group-context";

interface Props extends HTMLnexusuiProps<"span"> {
  /**
   * Ref to the DOM node.
   */

...
import {CloseIcon} from "@nexus-ds/shared-icons";
...
export interface ModalContentProps extends AriaDialogProps, HTMLnexusuiProps<"div", KeysToOmit> {
...
ModalContent.displayName = "nexusui.ModalContent";

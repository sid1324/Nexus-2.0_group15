import type {ModalVariantProps, SlotsToClasses, ModalSlots} from "@nexus-ds/theme";
import type {HTMLMotionProps} from "framer-motion";

import {AriaModalOverlayProps} from "@react-aria/overlays";
import {useAriaModalOverlay} from "@nexus-ds/use-aria-modal-overlay";
import {useCallback, useId, useRef, useState, useMemo, ReactNode} from "react";
import {modal} from "@nexus-ds/theme";
...
interface Props extends HTMLnexusuiProps<"section"> {
  /**
   * Ref to the DOM node.
   */

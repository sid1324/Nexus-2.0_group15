...
import type {SlotsToClasses, CardSlots, CardReturnType, CardVariantProps} from "@nexus-ds/theme";
...
import {ReactRef, filterDOMProps} from "@nexus-ds/react-utils";
import {useDOMRef} from "@nexus-ds/react-utils";
import {useRipple} from "@nexus-ds/ripple";

export interface Props extends HTMLnexusuiProps<"div"> {
  /**
   * Ref to the DOM node.
   */

import type {SlotsToClasses, UserSlots} from "@nexus-ds/theme";
import type {AvatarProps} from "@nexus-ds/avatar";

import {ReactNode, useMemo, useCallback} from "react";
import {useFocusRing} from "@react-aria/focus";
import {HTMLnexusuiProps, PropGetter} from "@nexus-ds/system";
import {user} from "@nexus-ds/theme";
import {clsx, dataAttr} from "@nexus-ds/shared-utils";
import {filterDOMProps, ReactRef} from "@nexus-ds/react-utils";
...
interface Props {
   ...
   * @see https://nexusui.org/docs/components/avatar
   */
...
export type UseUserProps = Props & Omit<HTMLnexusuiProps<"div">, "children">;

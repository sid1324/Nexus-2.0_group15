const App = `import {RadioGroup, Radio, useRadio, VisuallyHidden, cn} from "@nexus-ds/react";
...
const AppTs = `import {RadioGroup, Radio, useRadio, VisuallyHidden, RadioProps, cn} from "@nexus-ds/react";

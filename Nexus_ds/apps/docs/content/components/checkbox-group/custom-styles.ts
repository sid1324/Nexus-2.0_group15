const CustomCheckbox = `import {Checkbox, Link, User, Chip, cn} from "@nexus-ds/react";
...
const App = `import {CheckboxGroup} from "@nexus-ds/react";
    ...
    <div className="flex flex-col gap-1 w-full">
      ...
      >
        <CustomCheckbox
          ...
          user={{
            name: "Junior Garcia",
            avatar: "https://avatars.githubusercontent.com/u/87353374?v=4",

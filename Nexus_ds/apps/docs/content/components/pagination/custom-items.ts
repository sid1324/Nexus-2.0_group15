...
const AppTs = `import {Pagination, PaginationItemType, PaginationItemRenderProps} from "@nexus-ds/react";
...
const App = `import {Pagination, PaginationItemType} from "@nexus-ds/react";
import {ChevronIcon} from "./ChevronIcon";

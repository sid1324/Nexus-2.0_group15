...
const App = `import {Switch, VisuallyHidden, useSwitch} from "@nexus-ds/react";
...
const AppTs = `import {Switch, useSwitch, VisuallyHidden, SwitchProps} from "@nexus-ds/react";
import {MoonIcon} from "./MoonIcon";
import {SunIcon} from "./SunIcon";

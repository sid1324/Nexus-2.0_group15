...
Nexus Design System exports 4 card-related components:
...
<ImportTabs
  commands={{
    main: 'import {Card, CardHeader, CardBody, CardFooter} from "@nexus-ds/react";',
    individual: 'import {Card, CardHeader, CardBody, CardFooter} from "@nexus-ds/card";',
  }}
/>
...
You can use other Nexus Design System components inside the card to compose a more complex card.

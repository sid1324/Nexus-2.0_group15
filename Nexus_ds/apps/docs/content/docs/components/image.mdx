...
<ImportTabs
  commands={{
    main: 'import {Image} from "@nexus-ds/react";',
    individual: 'import {Image} from "@nexus-ds/image";',
  }}
/>
...
you can use it with Nexus Design System `Image` component as well.

<CodeDemo showPreview={false} title="With Next.js Image" files={imageContent.nextjs} />

> **Note**: Nexus Design System's `Image` component is `client-side`, using hooks like `useState` for loading states

...
Nexus Design System exports 3 avatar-related components:
...
<ImportTabs
  commands={{
    main: 'import {Avatar, AvatarGroup, AvatarIcon} from "@nexus-ds/react";',
    individual: 'import {Avatar, AvatarGroup, AvatarIcon} from "@nexus-ds/avatar";',
  }}
/>
...
Nexus Design System provides a `renderCount` prop to customize the count displayed when the `total` prop is passed.

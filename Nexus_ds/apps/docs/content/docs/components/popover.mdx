...
Nexus Design System exports 3 popover-related components:
...
<ImportTabs
  commands={{
    main: 'import {Popover, PopoverTrigger, PopoverContent} from "@nexus-ds/react";',
    individual: 'import {Popover, PopoverTrigger, PopoverContent} from "@nexus-ds/popover";',
  }}
/>

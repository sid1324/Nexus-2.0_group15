...
Nexus Design System exports 3 pagination-related components:
...
<ImportTabs
  commands={{
    main: 'import {Pagination, PaginationItem, PaginationCursor} from "@nexus-ds/react";',
    individual:
      'import {Pagination, PaginationItem, PaginationCursor} from "@nexus-ds/pagination";',
  }}
/>

...
Nexus Design System exports 2 button-related components:
...
<ImportTabs
  commands={{
    main: 'import {Button, ButtonGroup} from "@nexus-ds/react";',
    individual: 'import {Button, ButtonGroup} from "@nexus-ds/button";',
  }}
/>

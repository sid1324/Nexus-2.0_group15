...
<ImportTabs
  commands={{
    main: 'import {Link} from "@nexus-ds/react";',
    individual: 'import {Link} from "@nexus-ds/link";',
  }}
/>
...
Nexus Design System components expose a `as` prop that allows you to customize the React element type that is used to render the component.

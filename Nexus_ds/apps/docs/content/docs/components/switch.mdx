...
<ImportTabs
  commands={{
    main: 'import {Switch} from "@nexus-ds/react";',
    individual: 'import {Switch} from "@nexus-ds/switch";',
  }}
/>
...
> **Note**: Nexus Design System `Switch` also supports native events like `onChange`, useful for form libraries

      ...
      circles.push(
        <div
          ...
          style={{
            ...
            background: `linear-gradient(-180deg, rgba(${rgbaColors[i]}) 20%, hsl(var(--nexusui-background)) 100%)`,
          }}
        />,
      );
    }
      ...
      <div className="absolute top-1/2 left-1/2 overflow-visible -z-10">
        <div
          ...
          style={{
            ...
            background: `linear-gradient(-180deg, rgba(${rgbaColors[0]}) 40%, hsl(var(--nexusui-background)) 100%)`,
          }}
        />
        {renderCircles}
      </div>

...
export const useSandpack = ({
   ...
   */
  // const nexusComponents = useMemo(
  //   () =>
  //     Object.values(getNexusComponents(sortedFiles) || {}).flatMap((e) =>
  //       e.split(",").map((name) => name.replace(/"/g, "")),
  //     ),
  //   [sortedFiles],
  // );

  // const hasComponents = !isEmpty(nexusComponents);
  ...
  //   if (hasComponents) {
  //     let deps = {
  //       "@nexus-ds/theme": "dev-v2",
  //       "@nexus-ds/system": "dev-v2",
  //     };

  //     nexusComponents.forEach((component) => {
  //       deps = {
  //         ...deps,
  //         [`@nexus-ds/${component}`]: "dev-v2",
  //       };
  //     });
  ...
  //   return {
  //     ...deps,
  //     "@nexus-ds/react": "dev-v2",
  //   };
  // }, [hasComponents, nexusComponents, component]);

  // const tailwindConfigFile = useMemo(
  //   () => (hasComponents ? updateTailwindConfig(tailwindConfig, nexusComponents) : tailwindConfig),
  //   [tailwindConfig, nexusComponents],
  // );

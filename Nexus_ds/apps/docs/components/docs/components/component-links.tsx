import {Button, ButtonProps, Code, Link, Tooltip} from "@nexus-ds/react";
...
export const ComponentLinks = ({
  ...
  return (
    <div className="flex flex-wrap gap-3 mt-6">
      <ButtonLink
        href={`https://storybook-nexus.vercel.app/?path=/story/components-${
          storybook || component
        }--default`}
      ...
      <ButtonLink
        href={`https://www.npmjs.com/package/@nexus-ds/${component}`}

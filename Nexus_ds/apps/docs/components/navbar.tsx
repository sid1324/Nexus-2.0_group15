...
import {dataFocusVisibleClasses} from "@nexus-ds/theme";
import {ChevronDownIcon, LinkIcon} from "@nexus-ds/shared-icons";
...
export const Navbar: FC<NavbarProps> = ({children, routes, mobileRoutes = [], slug, tag}) => {
  ...
  const handleVersionChange = (key: Key) => {
    if (key === "v1") {
      const newWindow = window.open("https://v1.NexusDesign.org", "_blank", "noopener,noreferrer");
        ...
        <NavbarBrand as="li" className="gap-3 max-w-fit">
          ...
          {/* {ref.current ? (
            <Dropdown placement="bottom-start" portalContainer={ref.current}>
              ...
              <DropdownMenu
                aria-label="NexusDesign versions"
        ...
        <ul className="hidden lg:flex gap-4 justify-start items-center">
          ...
          {/* <NavbarItem>
            <NextLink
              ...
              href="/blog"
              onClick={() => handlePressNavbarItem("Blo g", "/blog")}
            >
              Blog
            </NextLink>
          </NavbarItem> */}
      ...
      <NavbarContent className="flex w-full gap-2 sm:hidden" justify="end">
        <NavbarItem className="flex h-full items-center">
          <Link
            ...
            aria-label="Github"
            className="p-1"
            href="https://github.com/NexusDesign-org/NexusDesign"
            onClick={() => handlePressNavbarItem("Github", "https://github.com/NexusDesign-org/NexusDesign")}
          >

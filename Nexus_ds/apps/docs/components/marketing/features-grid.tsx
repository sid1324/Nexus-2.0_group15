...
import {Card, CardHeader, CardBody, LinkProps, SlotsToClasses} from "@nexus-ds/react";
...
const styles = tv({
  slots: {
    ...
    body: "",
    iconWrapper:
      "flex justify-center p-2 rounded-full items-center bg-primary-100/40 text-blue-500",

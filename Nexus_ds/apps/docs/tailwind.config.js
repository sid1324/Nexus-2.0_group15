const {nexusui} = require("@nexus-ds/theme/plugin");
const {commonColors} = require("@nexus-ds/theme/colors");
  ...
  theme: {
    extend: {
      ...
      typography: (theme) => ({
        DEFAULT: {
          css: {
            color: "hsl(var(--nexusui-foreground))",
            maxWidth: "none",
            hr: {
              marginTop: "2em",
              marginBottom: "2em",
        ...
        dark: {
          css: {
            color: "hsl(var(--nexusui-default-700))",
            strong: {
        ...
        neutral: {
          css: {
            "--tw-prose-body": "hsl(var(--nexusui-default-700))",
            "--tw-prose-headings": "hsl(var(--nexusui-foreground))",
            "--tw-prose-lead": "hsl(var(--nexusui-default-600))",
            "--tw-prose-links": "hsl(var(--nexusui-default-900))",
            "--tw-prose-bold": "hsl(var(--nexusui-default-900))",
            "--tw-prose-counters": "hsl(var(--nexusui-default-500))",
            "--tw-prose-bullets": "hsl(var(--nexusui-default-300))",
            "--tw-prose-hr": "hsl(var(--nexusui-default-200))",
            "--tw-prose-quotes": "hsl(var(--nexusui-default-900))",
            "--tw-prose-quote-borders": "hsl(var(--nexusui-default-200))",
            "--tw-prose-captions": "hsl(var(--nexusui-default-500))",
            "--tw-prose-code": "hsl(var(--nexusui-default-900))",
            "--tw-prose-pre-code": "hsl(var(--nexusui-default-200))",
            "--tw-prose-pre-bg": "hsl(var(--nexusui-default-800))",
            "--tw-prose-th-borders": "hsl(var(--nexusui-default-300))",
            "--tw-prose-td-borders": "hsl(var(--nexusui-default-200))",
            "--tw-prose-invert-body": "hsl(var(--nexusui-default-300))",
            ...
            "--tw-prose-invert-pre-code": "hsl(var(--nexusui-default-300))",
